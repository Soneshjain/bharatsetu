...
// 3. Get schemes by type
router.get('/schemes/type/:type', async (req, res) => {
    try {
...
// 4. Get schemes by category
router.get('/schemes/category/:categoryId', async (req, res) => {
    try {
...
// 6. Search schemes
router.get('/schemes/search/:query', async (req, res) => {
    try {
...
// 11. Get scheme statistics
router.get('/schemes/:schemeId/stats', async (req, res) => {
    try {
        const { schemeId } = req.params;
