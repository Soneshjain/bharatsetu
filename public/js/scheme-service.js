...
class SchemeService {
    ...
    async getApplicationStatuses() {
        return await this.makeRequest(`${this.baseUrl}/application-statuses`);
    }

    // Create application
    async createApplication(applicationData) {
        return await this.makeRequest(`${this.baseUrl}/applications`, {
            method: 'POST',
    ...
    async getUserApplications(userId) {
        return await this.makeRequest(`${this.baseUrl}/applications/user/${userId}`);
    }

    // Update application status
    async updateApplicationStatus(applicationId, statusId) {
        return await this.makeRequest(`${this.baseUrl}/applications/${applicationId}/status`, {
            method: 'PUT',
